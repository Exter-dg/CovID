                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <!-- Create / Delete Centres -->
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Create / Delete Centres</h6>
                                </div>
                                <div class="card-body">
                                    <p>This can be used to Display Centres, Add new centres or Delete centres. It also has
                                        features to search centres according to various filters.
                                    </p>
                                    <a href="admin-centre.php" class="btn btn-secondary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
                                        <span class="text">Admin Centre Management</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Approve Admins</h6>
                                </div>
                                <div class="card-body">
